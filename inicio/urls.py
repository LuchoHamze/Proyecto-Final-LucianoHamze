...
from inicio.views import inicio, paletas, explicacion_productos, tiendaproductos, productos_por_categorias, crear_producto, buscar_productos, eliminar_producto, actualizar_producto, detalle_producto
